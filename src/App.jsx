...
// another way. 77% of Origin's traffic is mobile — see ORIGIN_BRAND.md §3.
...
// alone isn't either — a narrow window on a desktop would still get the rail
...
// desktop pixels over SA mobile networks (ORIGIN_BRAND.md §11). Widths are
// keyed by filename suffix; '' is the full-size original.
//   responsive(src, { sm: 768, md: 1280, '': 1920 }, '100vw')
// `sizes` must subtract the page gutters — describing a gutter-padded image as
      ...
      >
        <div className="max-w-[1800px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20 lg:h-24">
            ...
            {/* Icons — 44px hit areas per ORIGIN_BRAND.md §5 (touch targets) */}
    ...
    <section className="relative h-[100svh] min-h-[560px] overflow-hidden">
      ...
      >
        <img
          ...
          alt="Origin — South African contemporary fashion"
          fetchPriority="high"
          decoding="async"
...
const Marquee = () => {
  const text = "NATURAL FIBRES • HONEST CONSTRUCTION • DESIGNED IN SOUTH AFRICA • FREE SHIPPING ON ORDERS OVER R1,500 • NEW SEASON NOW LIVE • ";
...
// Sizing opens a sheet, never a dropdown (ORIGIN_BRAND.md §7). Sold-out sizes
// stay visible and struck through — the brand shows the truth about
// availability rather than hiding it (§2, Honesty).
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quick Add Overlay — pointer devices only */}
        {hoverLayout && (
          <motion.div
            initial={{ y: '100%' }}
        ...
        {/* Gallery dots — always visible on touch, per §7 */}
        {!hoverLayout && (
      ...
      <div className="mt-3 lg:mt-4">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          {/* Sale prices carry signal blue; full prices stay ink (§5) */}
    ...
    <section ref={ref} className="py-24 lg:py-32 bg-[#FDFBF8]">
      <div className="px-6 lg:px-12 max-w-[1800px] mx-auto">
        ...
        >
          ...
          {/* Products Grid — 2 / 3 / 4 columns per ORIGIN_BRAND.md §5 */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-[#9B8B7A] text-lg font-light leading-relaxed mb-8">
            Origin began in 2021 as Nanayhaa, after its founder, Abenathi Nanayhaa Mtshiyo. The name changed; the intention did not. Origin is design at its genesis — the structure, the craft and the traditions that existed long before any of it was called fashion.
          </motion.p>
        ...
        >
          <div className="aspect-[4/5] overflow-hidden">
            <motion.img
              ...
              alt="Origin studio — South African craftsmanship"
              loading="lazy"
              decoding="async"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-24 items-center">
        ...
        >
          <div className="aspect-[4/5] overflow-hidden bg-[#F2ECE2]">
            <img
              ...
              alt="Origin menswear — linen overshirt, Autumn / Winter 2026"
              loading="lazy"
              decoding="async"
              className="w-full h-full object-cover"
            />
        ...
        >
          ...
          <motion.p variants={fadeInUp} className="text-[#9B8B7A] text-base lg:text-lg font-light leading-relaxed mb-8">
            Overshirts cut with room to move. Linen that softens every time you wash it. Heavy cotton that keeps its shape. The shirt that fits and the trousers that move — worn until they are yours.
          </motion.p>
          <motion.div variants={fadeInUp}>
...
const OriginStandard = () => {
  ...
  // Drawn straight from the values table in ORIGIN_BRAND.md §2.
  const standards = [
    {
    ...
    },
    {
      ...
      body: "No countdown timers and no “only two left”. When a size is gone it stays on the page, struck through."
    },
    {
      title: "XS to XL",
  ...
  return (
    <section ref={ref} className="py-20 lg:py-28 px-6 lg:px-12 max-w-[1800px] mx-auto">
      ...
      >
        ...
        {/* Elevation comes from hairlines and spacing, never shadows (§5) */}
...
// supplies its own graded spec — confirm every figure before launch.
const SIZE_CHARTS = {
  Womens: {
